<template>
    ...
    <main>
        <div class="info-text">
            ...
            <p>My creative journey spans 2D illustration and concept art, as well as 3D modeling and animation.</p>
            ...
            <p>I'm particularly interested in opportunities that allow me to contribute my unique style and technical abilities to bring creative visions to fruition.</p>
            <p>I'm excited to connect and explore how my artistic skills can serve your project.</p>
            <p class="text-center">neofy.artist@gmail.com</p>
        </div>
    </main>
</template>
